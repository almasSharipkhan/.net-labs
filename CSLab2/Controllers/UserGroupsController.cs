...
namespace CSLab2.Controllers
{
    public class UserGroupsController : Controller
    {
        ...
        public UserGroupsController(MainContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] UserGroup userGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] UserGroup userGroup)
        {
            if (id != userGroup.Id)
            {
                return NotFound();
